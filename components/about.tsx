...
export default function About() {
  ...
  return (
    ...
    >
      ...
      I decided to pursue my passion for programming. In my undergraduate life, I
      worked on <span className="font-medium">Python</span>, focusing on{" "}
      <span className="font-medium">Machine Learning</span> and{" "}
      <span className="font-medium">AI</span>. I am familiar with{" "}
      <span className="font-medium">NextJS, React, TypeScript, C++, Django, Flask, FastAPI</span>.{" "}
      <span className="italic">My favorite part of programming</span> is the
      problem-solving aspect, particularly in the <span className="font-medium">Backend</span>. I{" "}
      ...
      . I am also familiar with <span className="font-medium">Prisma</span> and
